...
<header>
  <nav class="bg-white border-b-2 border-gray-200 px-4 lg:px-6 py-2.5">
    <div
    ...
    >
      <a href="https://flowbite.com" class="flex items-center">
        ...
        />
        <span
          class="self-center text-xl font-semibold whitespace-nowrap text-fuchsia-400"
          >Moo6</span
        >
      </a>
      ...
      >
        ...
        >
          ...
          <li>
            <a
              href="/"
              class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400"
              >Company</a
            >
          </li>
          <li>
